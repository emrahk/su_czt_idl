...
;-----------------------------------------------------------------
pro convolvewithmask,data,image,estpos,pe,opix=pixenergy
;-----------------------------------------------------------------
;
;-----------------------------------------------------------------

  if not keyword_set(pixenergy) then getpixenergy,data,pixenergy
  ...
  estpos = [posx,posy]
  print,"Estimated posisiton  :"
  print,estpos[0],"mm",estpos[1],"mm"
